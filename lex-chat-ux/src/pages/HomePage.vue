  ...
  <q-layout view="hHh lpR fFf">
    ...
    <q-header elevated class="bg-white text-dark">
      <q-toolbar class="max-w-7xl mx-auto">
        ...
        <q-btn flat label="과정안내" class="q-mx-sm text-gray-700 hover:text-academy-primary" />
        <q-btn flat label="수강신청" class="q-mx-sm text-gray-700 hover:text-academy-primary" />
        <q-btn flat label="학원소개" class="q-mx-sm text-gray-700 hover:text-academy-primary" />
        <q-btn flat label="오시는길" class="q-mx-sm text-gray-700 hover:text-academy-primary" />
        <q-btn 
          unelevated 
          rounded 
          label="상담신청" 
          ...
          <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div 
                ...
                :key="feature.id"
                class="text-center p-6 bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow"
              >
                <q-icon 
                  :name="feature.icon" 
                  size="48px" 
